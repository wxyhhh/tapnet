...
parser.add_argument('--random_projection', type=int, default=10,
                    help='The number of times doing random projection')
parser.add_argument('--sub_dim', type=int, default=3,
                    help='Number of sub-dimension for each random projection')
...
if model_type == "TapNet":
    ...
    model = TapNet(nfeat=features.shape[1],
                   ...
                   random_projection_size=args.random_projection,
                   subdim_size=args.sub_dim
                   )
...
def train():
    test_best_possible = 0.0
    best_so_far=10000000.0
    ...
    return (test_best_possible,test_acc)        

[test_best_possible,test_acc]=train()
